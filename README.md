...
In the wake of the Mt. Gox, Bitstamp debacle merkle-sum-trees for
...
A solution to this would be implementing a zero-knowledge-proof of 
blinded account sum trees so as to not leak any information.
...
2) Prove that those txout(s) have not been re-used in any other proof of
...
From: Peter Todd <pete@pe...> - 2014-03-25 22:05:28
